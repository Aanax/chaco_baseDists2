#!/bin/sh
#SBATCH --job-name=chac-experiment
#SBATCH -D /s/ls4/users/aamore/BaseDists_ver_before_sVAE_hevyside/
#SBATCH -o /s/ls4/users/aamore/BaseDists_ver_before_sVAE_hevyside/logs/%j.out
#SBATCH -e /s/ls4/users/aamore/BaseDists_ver_before_sVAE_hevyside/logs/%j.err
#SBATCH -t 0:10:00
#SBATCH --nodes 1
#SBATCH --gres=gpu:4
